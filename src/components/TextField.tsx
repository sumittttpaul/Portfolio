    ...
    <div className="relative mx-px mt-[1.5em] flex space-x-5 md:mx-[3em] md:mt-[3em] md:space-x-10">
      ...
      <div className="flex w-full flex-col space-y-2">
        ...
        <input
          ...
          className="w-full bg-white pb-[1.75em] pt-[0.5em] text-[14px] font-bold leading-[0] text-black outline-none placeholder:font-medium placeholder:text-black/40 xs:pb-[1.5em] xs:text-[clamp(18px,1.5vw,1.5em)] md:pb-[2.25em]"
        />
        {error && (
