...
const Project = ({
  ...
  return (
    <div
      ...
      className="border-light-gray last-of-type:border-light-gray group flex w-full cursor-pointer items-center justify-between border-t px-[100px] py-[50px] transition-all duration-200 last-of-type:border-b last-of-type:border-solid md:px-[50px] lg:px-[150px]"
    >
