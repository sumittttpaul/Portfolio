...
export default function About() {
  return (
    <section className="relative flex h-full w-full flex-col overflow-hidden bg-white">
      ...
      <div className="relative mx-auto flex w-full max-w-screen-max-size flex-col items-center justify-center px-5 pb-[200px] pt-[100px] font-normal text-black md:mx-20 md:flex-row md:space-x-[5em] md:py-[200px] max-size:mx-auto">
      ...
      >
        <DivInViewAnimation
          ContainerClassName="relative grid h-[750px] w-full place-content-start rounded-[40px] bg-black p-5 sm:h-[500px] sm:place-content-center sm:p-10 screen-1000:h-[800px]"
          ChildClassName="box-border flex flex-col sm:relative sm:h-[288px] sm:w-[545px] sm:flex-row screen-1000:h-[501px] screen-1000:w-[950px] screen-1180:h-[570px] screen-1180:w-[1080px]"
        >
          {/* User photo */}
          <PhotoButton />
